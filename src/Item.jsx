  ...
  render(){
    return(
      <Page renderToolbar={this.renderToolbar}>
        <li>体温：{this.props.data+"℃"}</li>
        <li>記録日：{this.props.time.getFullYear()+"年"+(this.props.time.getMonth()+1)+"月"+this.props.time.getDate()+"日"+this.props.time.getHours()+"時"+this.props.time.getMinutes()+"分"+this.props.time.getSeconds()+"秒"}</li>
      </Page>
    )
  }
}